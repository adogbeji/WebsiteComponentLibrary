...
function openMobileSearchBar() {
  document.getElementById('firstMobileNavOverlay').style.width = '100%';
}

/* Close when someone clicks on the 'x' symbol in the search bar */
function closeMobileSearchBar() {
  document.getElementById('firstMobileNavOverlay').style.width = '0%';
}
...
// /* Open */
// function openMobileSearchBar() {
//     document.getElementById('firstMobileNavOverlay').style.height = '100%';
// }
  
// /* Close */
// function closeMobileSearchBar() {
//     document.getElementById('firstMobileNavOverlay').style.height = '0%';
// }
...
// /* Open */
// function openMobileSearchBar() {
//     document.getElementById('firstMobileNavOverlay').style.display = 'block';
// }
  
// /* Close */
// function closeMobileSearchBar() {
//     document.getElementById('firstMobileNavOverlay').style.display = 'none';
// }
